...
// Constructeur d'image chargÈe par stbi
...
// Constructeur d'image vide ÅEdes dimensions et nombre de canaux donnÈs
...
// CoordonnÈes u et v entre 0 et 1
// recalibrÈes par rapport ‡ la taille de l'image
